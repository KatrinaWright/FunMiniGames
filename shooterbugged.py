...
# Set up the enemies
enemies = [pygame.Rect(random.randint(0, WIDTH - 25), random.randint(0, HEIGHT - 25), 25, 25) for _ in range(10)]
for enemy in enemies:
    if random.random() < 0.25:  # 25% chance of being green
        enemy.color = (0, 255, 0)  # Green color
        enemy.speed = ENEMY_SPEED / 2  # Half speed
    else:
        enemy.color = (255, 0, 0)  # Red color
        enemy.speed = ENEMY_SPEED  # Standard speed
    ...
    for i, enemy in enumerate(enemies):
        ...
        for j, projectile in enumerate(projectiles):
            ...
            if enemy.colliderect(proj_rect):
                ...
                enemies.append(pygame.Rect(random.randint(0, WIDTH - 25), random.randint(0, HEIGHT - 25), 25, 25))
                break
